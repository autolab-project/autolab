...
usage:    autolab-drivers [options] arg 
    ...
    autolab-drivers -d {MODULE.__name__} -i GPIB::7::INSTR -l VISA -a 0.5 -f 10e6
    ...
    Execute some_methods of the driver. A list of available methods is present at the top of this help along with arguments definition.
        ...
        parser.add_argument("-u", "--unenable", action='store_true', dest="unenable", default=None, help="Turn the RF output off." )
