# -*- coding: utf-8 -*-
"""
Created on Wed Oct  2 21:21:05 2019
...
#
#    my_xps = XPS()
#    my_socketId = my_xps.TCP_ConnectToServer('192.168.0.254',5001,1)
#    output=my_xps.GroupPositionCurrentGet(my_socketId,'NSR1',1)[1]
#    my_xps.GroupMoveAbsolute(my_socketId,'NSR1',[15])
#    output=my_xps.GroupPositionCurrentGet(my_socketId,'NSR1',1)[1]
#    my_xps.TCP_CloseSocket(my_socketId)
#    print(output)
