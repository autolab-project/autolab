...
usage:    autolab-drivers [options] arg 
    ...
    autolab-drivers -d {MODULE.__name__} -l SOCKET -i 192.168.0.2 -c Camera1 -n 2 -e 0.1 -o my_file_name
    ...
    Execute some_methods of the driver. A list of available methods is present at the top of this help along with arguments definition.
        ...
        parser.add_argument("-p", "--camera", type=str, dest="camera", default=None, help="Set the camera to get the data from." )
    ...
    def do_something(self,args):
        ...
        if args.auto_exposure and args.filename:
            getattr(self.Instance,'auto_exposure')()
