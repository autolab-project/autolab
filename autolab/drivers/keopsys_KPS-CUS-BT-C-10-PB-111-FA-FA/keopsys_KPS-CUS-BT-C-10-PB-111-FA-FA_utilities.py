...
usage:    autolab driver [options] args
    ...
    autolab driver -D {self.name} -A GPIB::2::INSTR -C VISA -p 10
    ...
    def add_parser_arguments(self,parser):
        ...
        parser.add_argument("-p", "--power", type=str, dest="power", default=None, help="Set the pump power setpoint in dBm.")
        parser.add_argument("-o", "--output", type=str, dest="output", default=None, help="Set the device output state.")
